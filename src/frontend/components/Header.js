...
function Header() {
  ...
  const history = useHistory()  // <- Crea la instancia de history
  ...
  const handleLogout = () => {
    localStorage.removeItem('token') // Elimina token para cerrar sesión
    history.push('/login') // Redirige a login usando history.push
  }
